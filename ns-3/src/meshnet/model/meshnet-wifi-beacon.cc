...
MeshnetWifiBeacon::MeshnetWifiBeacon (Ssid ssid, SupportedRates rates, uint64_t us)
{
...
void
MeshnetWifiBeacon::AddInformationElement (Ptr<WifiInformationElement> ie)
{
  m_elements.AddInformationElement (ie);
}

Time
MeshnetWifiBeacon::GetBeaconInterval () const
{
  return MicroSeconds (m_header.GetBeaconIntervalUs ());
}

Ptr<Packet>
MeshnetWifiBeacon::CreatePacket ()
{
...
WifiMacHeader
MeshnetWifiBeacon::CreateHeader (Mac48Address address, Mac48Address mpAddress)
{
  WifiMacHeader hdr;
