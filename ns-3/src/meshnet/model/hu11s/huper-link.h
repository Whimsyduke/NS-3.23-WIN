...
public:
  ...
  void SetHuperMeshnetPointAddress (Mac48Address macaddr);
...
private:
  ...
  /// Meshnet point address, equal to huper address in case of single
  /// interface meshnet point
  Mac48Address m_huperMeshnetPointAddress;
  /// My ID of this link
  ...
  HuperState m_state;
  /**
   * \brief Meshnet interface configuration
   ...
   * \{
   */
  uint16_t m_dot11MeshnetMaxRetries;
  Time     m_dot11MeshnetRetryTimeout;
  Time     m_dot11MeshnetHoldingTimeout;
  Time     m_dot11MeshnetConfirmTimeout;
