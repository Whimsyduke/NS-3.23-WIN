 ...
 * 
 * \brief IEEE 802.11s (meshnet) draft standard implementation
 * 
 ...
 * 
 * The multi-interface meshnet points are supported as an 
 ...
 * Huper management protocol and MGMP - Hybrid Wireless Meshnet Protocol.
 * 
 ...
 * ns3::MeshnetWifiInterfaceMacPlugin
 ...
 * Note, that HuperManagementProtocol is not attached to MeshnetPointDevice as a routing protocol,
 ...
 * 
 * \subsection MGMP Hybrid Wireless Meshnet Protocol
