...
enum PmpReasonCode
{
  ...
  REASON11S_MESHNET_MAX_HUPERS = 53,
  REASON11S_MESHNET_CAPABILITY_POLICY_VIOLATION = 54,
  REASON11S_MESHNET_CLOSE_RCVD = 55,
  REASON11S_MESHNET_MAX_RETRIES = 56,
  REASON11S_MESHNET_CONFIRM_TIMEOUT = 57,
  REASON11S_MESHNET_INVALID_GTK = 58,
  REASON11S_MESHNET_INCONSISTENT_PARAMETERS = 59,
  REASON11S_MESHNET_INVALID_SECURITY_CAPABILITY =60,
