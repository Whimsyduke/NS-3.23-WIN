...
#ifndef MESHNET_INFORMATION_ELEMENT_H
#define MESHNET_INFORMATION_ELEMENT_H
...
#define IE11S_MESHNET_CHANNEL_SWITCH_ANNOUNCEMENT ((WifiInformationElementId)24)
#define IE11S_MESHNET_TIM                         ((WifiInformationElementId)25)
