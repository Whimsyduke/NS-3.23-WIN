...
#ifndef MESHNET_HU11S_CONFIGURATION_H
#define MESHNET_HU11S_CONFIGURATION_H
...
{
  AUTH_NULL = 0x00,  //No authentication method is required to establish meshnet huperings within the MBSS
 ...
 */
class Hu11sMeshnetCapability
{
public:
  Hu11sMeshnetCapability ();
  ...
  friend bool operator== (const Hu11sMeshnetCapability & a, const Hu11sMeshnetCapability & b);
};

/**
 * \ingroup hu11s
 * \brief Describes Meshnet Configuration Element 
...
public:
  ...
  Hu11sMeshnetCapability const& MeshnetCapability ();
...
private:
  ...
  Hu11sMeshnetCapability m_meshnetCap;
  uint8_t m_neighbors;
...
bool operator== (const Hu11sMeshnetCapability & a, const Hu11sMeshnetCapability & b);
