...
#ifndef MESHNET_WIFI_BEACON_H
#define MESHNET_WIFI_BEACON_H
 ...
 *
 * It is supposed that distinct meshnet protocols can use beacons to transport
 * their own information elements.
 */
class MeshnetWifiBeacon
{
public:
  /**
   * C-tor
   ...
   */
  MeshnetWifiBeacon (Ssid ssid, SupportedRates rates, uint64_t us);
   ...
   * \param mpAddress is meshnet point address
   */
