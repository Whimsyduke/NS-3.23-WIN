...
#ifndef MESHNET_WIFI_INTERFACE_MAC_PLUGIN_H
#define MESHNET_WIFI_INTERFACE_MAC_PLUGIN_H
...
class MeshnetWifiInterfaceMac;

/**
 * \ingroup meshnet
 * 
 * \brief Common interface for meshnet point interface MAC plugins
 * 
 * \todo plugins description
 */
class MeshnetWifiInterfaceMacPlugin : public SimpleRefCount<MeshnetWifiInterfaceMacPlugin>
{
public:
  /// This is for subclasses
  virtual ~MeshnetWifiInterfaceMacPlugin (){};
  /// Each plugin must be installed on interface to work 
  virtual void SetParent (Ptr<MeshnetWifiInterfaceMac> parent) = 0; 
  /** 
   ...
   * \todo define when MAC call this
   */
  virtual void UpdateBeacon (MeshnetWifiBeacon & beacon) const = 0;
  /**
...
#endif /* MESHNET_WIFI_INTERFACE_MAC_PLUGIN_H */
